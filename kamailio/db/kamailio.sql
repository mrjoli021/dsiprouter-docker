...
CREATE TABLE `topos_t` (
  ...
  `x_rr` mediumtext NOT NULL,
  `y_rr` mediumtext NOT NULL,
  `s_rr` mediumtext NOT NULL,
...
-- Dump completed on 2021-01-11 15:33:01
